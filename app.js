...
log = bunyan.createLogger({ name: "Dev-Markit" });
...
log.info("Initiating web3 provider");
...
log.info("web3 providers finished");
...
log.info("Creating subscription for pendingTransactions")
...
process.on('unhandledRejection', (err, p) => {
    send("Error while connecting quorum / Quorum node down : 10.35.241.251- Dev Markit");
    log.error(err);
});
